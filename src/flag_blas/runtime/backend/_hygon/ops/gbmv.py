...
from flag_blas.ops.level2.gbmv import (
    ...
    _f64_to_i64,
    _pick_split_band,
    cgbmv as common_cgbmv,
    cgbmv_t_kernel as common_cgbmv_t_kernel,
    dgbmv as common_dgbmv,
    ...
    zgbmv as common_zgbmv,
    zgbmv_t_kernel as common_zgbmv_t_kernel,
)
...
def _pick_dgbmv_split_hygon(
    trans: int, m: int, n: int, out_len: int, band: int
) -> int:
