...
def cublas_her2_baseline(
    A, x, y, uplo, n, alpha, incx, incy, lda, handle, c_func, alpha_c, **kwargs
):
    if n == 0:
        return A
    status = c_func(
...
def gems_cher2_wrapper(A, x, y, uplo, n, alpha, incx, incy, lda, handle, **kwargs):
    flag_blas.ops.cher2(uplo, n, alpha, x, incx, y, incy, A, lda)
    return A


def gems_zher2_wrapper(A, x, y, uplo, n, alpha, incx, incy, lda, handle, **kwargs):
    flag_blas.ops.zher2(uplo, n, alpha, x, incx, y, incy, A, lda)
    return A
...
class Her2Benchmark(Benchmark):
    ...
    def clone_correctness_inputs(self, args, kwargs):
        A, x, y = args
        return (A.clone(), x, y), kwargs, (A.clone(), x, y), kwargs
